...
public class AutoLinearLayout extends LinearLayoutManager {
    private static final String TAG = AutoLinearLayout.class.getSimpleName(); public AutoLinearLayout(Context context) {
        super(context);
    }
    public AutoLinearLayout(Context context, int orientation,
